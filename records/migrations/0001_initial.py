# Generated by Django 4.2.1 on 2025-03-14 12:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='tag_requests', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_published', models.BooleanField(choices=[(True, 'Активно'), (False, 'В корзине')], default=1, verbose_name='Статус')),
                ...
                ('cat', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='posts', to='records.category', verbose_name='Категории')),
                ('tags', models.ManyToManyField(blank=True, related_name='tags', to='records.tagpost', verbose_name='Тэги')),
            ],
            options={
                'verbose_name': 'пост',
                'verbose_name_plural': 'посты',
                'ordering': ['-time_create'],
                'indexes': [models.Index(fields=['-time_create'], name='records_rec_time_cr_3402a4_idx')],
            },
        ),
    ]
